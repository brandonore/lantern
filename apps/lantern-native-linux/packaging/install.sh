...
ICON_SOURCE="${ROOT_DIR}/apps/lantern-native-linux/assets/lantern_logo.png"
...
magick "${ICON_SOURCE}" -resize 32x32   "${ICON_32_PATH}"
magick "${ICON_SOURCE}" -resize 128x128 "${ICON_128_PATH}"
magick "${ICON_SOURCE}" -resize 256x256 "${ICON_256_PATH}"
